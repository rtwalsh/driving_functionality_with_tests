...
public abstract class GateBasedDealsApplicator {
    ...
    public static GateBasedDealsApplicator createInstance(AssetVendorRelationshipLevel highestRelationshipLevel, AssetAssessments assessments, AssetMeasurements measurements) {
