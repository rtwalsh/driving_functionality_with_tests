...
public class SilverGateBasedDealsApplicator extends GateBasedDealsApplicator {
    public SilverGateBasedDealsApplicator(AssetAssessments assessments, AssetMeasurements measurements) {
